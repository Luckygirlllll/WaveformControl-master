...
public class PlaybackThread {
    ...
    public PlaybackThread(short[] samples, PlaybackListener listener, MainActivity mainActivity) {
        mSamples = ShortBuffer.wrap(samples);
        mNumSamples = samples.length;
        mListener = listener;
        myCallback = (MyCallback)mainActivity;
      //  myCallback.callbackCall(12398);
    }
    ...
    private void play() {
        ...
        myCallback.callbackCall(totalWritten);
